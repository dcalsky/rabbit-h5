      ...
      <div className="bg">
        ...
        </div>
        {
          loading ? <img
            ...
            :
            <Stage ref={measuredRef} className="stage" width={screenWidth} height={642}>
              <Layer>
                <Rect width={screenWidth} height={642} fill="#ffffff" />
              </Layer>
              <Layer>
                <Image x={gap / 2} y={18} width={imgWidth} height={imgHeight} image={image} />
                ...
                <Text fontFamily="happy" x={108} y={205} fontSize={21} width={48} height={48} fill="#ffffff"
                      text={words[3]} />
                <Text width={270} x={gap / 2} height={10} y={imgHeight + 40} fontSize={23} fontStyle="bold"
                      fill="#A1A1A1"
                      text={`2021的${username}`} />
                <Text x={gap / 2} y={imgHeight + 40 + 38} fontSize={18} fontStyle="bold" fill="#A1A1A1"
                      text={"寒来暑往，新年快乐。"} />
                <Text x={gap / 2} y={imgHeight + 40 + 38 + 25} fontSize={12} fontStyle="bold" fill="#C7C7C7"
